...
- [x] 2021/02/10 复习链表 计网(应用层/传输层)
- [x] 2021/02/11 团年
- [x] 2021/02/12 春节 二分法/数组 
- [x] 2021/02/13 堆/栈/队列 DFS/BFS
- [x] 2021/02/14 询问hw等情况, 了解上海北京职位, 动态规划, 链路层/复习43/http过程
- [x] 2021/02/15 LRU, 并查集
- [x] 2021/02/16 操作系统1234(面试题总结), 哈希表算法复习, 贪心算法复习, 做简历
- [x] 2021/02/17 java集合复习, 数据库复习, logn排序, 数学/字符串
- [ ] 2021/02/18 逆序对, 链表排序, 2链表插入, 前k个最大的, 数据库高级
- [ ] 2021/02/19 位运算, 多线程, 数据库底层
- [ ] 2021/02/20 复习spring, 查漏补缺
- [ ] 2021/02/21 java集合, 单例模式, 工厂模式
- [ ] 2021/02/22 投递简历, 做excel表格
...
## todo
1. MySQL索引, b or b+ tree?
2. 大量的数排序?
3. 装箱拆箱
4. [有效位](https://www.zhihu.com/question/274137101)
5. 对象创建过程
6. java输入
